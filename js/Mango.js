...
if(index === 5){
    document.getElementById("paragraph 1").innerHTML = el.mango.p1;
    document.getElementById("paragraph 2").innerHTML = el.mango.p2;
    document.getElementById("paragraph 3").innerHTML = el.mango.p3;
    document.getElementById("heading").innerHTML = el.mango.h1;
    document.getElementById("paragraph 4").innerHTML = el.mango.p4;
    document.getElementById("paragraph 5").innerHTML = el.mango.p5;
}
}); 
